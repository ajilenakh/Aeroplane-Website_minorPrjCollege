    ...
    <section class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8 min-h-screen flex items-center justify-center">
      ...
      <div class="isolate bg-white flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
        ...
        <div class="md:w-1/2 px-8 md:px-16">
          ...
          <form action="registerProcess.php" method="POST" class="flex flex-col gap-4" onsubmit="return validateForm()">
            ...
            <div class="relative">
              <input class="p-2 mt-4 rounded-xl border w-full" type="password" name="password" id="password" placeholder="Password" required>
              <input class="p-2 mt-2 rounded-xl border w-full" type="password" name="confirmPassword" id="confirmPassword" placeholder="Confirm Password" required>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="gray" class="bi bi-eye absolute top-1/3 right-3 -translate-y-1/2 cursor-pointer" viewBox="0 0 16 16" id="togglePassword">
            ...
            <button class="bg-[#4F46E5] rounded-xl text-white py-2 hover:scale-105 duration-300" type="submit">SignUp</button>
          </form>

          <div class="text-xs border-b border-[#1E739F] py-4 text-[#002D74]"></div>

          <div id="loginButton" class="mt-3 text-xs flex justify-between items-center text-[#002D74]">
            <p>Existing member?</p>
